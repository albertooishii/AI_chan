...
void main() {
  testWidgets(
    'desktop dialog shows copy and sign-in when lastAuthUrl is set before open',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(home: Scaffold(body: GoogleDriveBackupDialog())),
      );
  ...
  testWidgets('desktop dialog watcher picks up auth url set after open', (
    WidgetTester tester,
  ) async {
