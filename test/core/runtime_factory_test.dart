...
void main() {
  test('getRuntimeAIServiceForModel selects and caches runtimes', () async {
    final a = runtime_factory.getRuntimeAIServiceForModel('gpt-4o');
    final b = runtime_factory.getRuntimeAIServiceForModel('gpt-4o');
    expect(identical(a, b), true);

    final g = runtime_factory.getRuntimeAIServiceForModel('gemini-2.5-flash');
    expect(g, isNotNull);
