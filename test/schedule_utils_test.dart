...
void main() {
  ...
  group('ScheduleUtils.parseDiasToWeekdaySet', () {
    ...
    test('individual days and accents', () {
      final set = ScheduleUtils.parseDiasToWeekdaySet(
  ...
  group('ScheduleUtils.isTimeInRange', () {
    ...
    test('invalid inputs return null', () {
      expect(
        ScheduleUtils.isTimeInRange(currentMinutes: 0, from: '', to: '02:00'),
        isNull,
      );
      expect(
        ScheduleUtils.isTimeInRange(currentMinutes: 0, from: '23:00', to: ''),
        isNull,
      );
      expect(
        ScheduleUtils.isTimeInRange(
