...
void main() {
  group('generateFullBiographyFlexible', () {
    ...
    test(
      'integrates appearance generator and saves image via saveImageFunc',
      () async {
        // Deterministic saveImageFunc for test
        Future<String?> deterministicSaver(
          String base64, {
          String prefix = 'ai_avatar',
        }) async {
        ...
        expect(bio.avatar!.seed, equals('123'));
