...
void main() {
  group('🔍 Validation Service Tests', () {
    test('should validate and save correct data successfully', () {
      // Datos válidos
      final result = ConversationalOnboardingService.validateAndSaveData('userName', 'Alberto');
    ...
    test('should reject empty country data', () {
      ...
      final result = ConversationalOnboardingService.validateAndSaveData('userCountry', '');
    ...
    test('should accept valid date formats', () {
      ...
      final result = ConversationalOnboardingService.validateAndSaveData('userBirthdate', '15/03/1990');
    ...
    test('should accept valid country names', () {
      // País válido
      final result = ConversationalOnboardingService.validateAndSaveData('userCountry', 'España');
    ...
    test('should accept AUTO_GENERATE_STORY flag for meet story', () {
      final result = ConversationalOnboardingService.validateAndSaveData('meetStory', 'AUTO_GENERATE_STORY');
    ...
    test('should accept user provided meet story', () {
      final story = 'Nos conocimos en una cafetería en Madrid, él se acercó y me ofreció un libro.';
      final result = ConversationalOnboardingService.validateAndSaveData('meetStory', story);
    ...
    test('should accept ai name and trim', () {
      final result = ConversationalOnboardingService.validateAndSaveData('aiName', 'Yuna');
    ...
    test('should accept ai country value', () {
      final result = ConversationalOnboardingService.validateAndSaveData('aiCountry', 'JP');
    ...
    test('should reject empty or whitespace-only names', () {
      ...
      final result = ConversationalOnboardingService.validateAndSaveData('userName', '   ');
    ...
    group('Date Format Validation', () {
      test('should accept DD/MM/YYYY format', () {
        final result = ConversationalOnboardingService.validateAndSaveData('userBirthdate', '25/12/1995');

        expect(result['isValid'], isTrue);
      });

      test('should reject natural language date (requires DD/MM/YYYY format)', () {
        final result = ConversationalOnboardingService.validateAndSaveData(
          'userBirthdate',
      ...
      test('should reject non-date text', () {
        final result = ConversationalOnboardingService.validateAndSaveData('userBirthdate', 'No recuerdo exactamente');
