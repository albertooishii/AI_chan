...
void main() {
  ...
  test('ChatJsonUtils.importAllFromJson accepts valid JSON and rejects corrupted', () async {
    ...
    String? errMsg;
    final importedGood = await chat_json_utils.ChatJsonUtils.importAllFromJson(jsonEncode(goodMap), onError: (e) => errMsg = e);
    ...
    errMsg = null;
    final importedMalformed = await chat_json_utils.ChatJsonUtils.importAllFromJson('not a json', onError: (e) => errMsg = e);
