...
Future<List<Map<String, dynamic>>> getOpenAIVoices({bool forceRefresh = false, bool femaleOnly = false}) {
  return OpenAISpeechService.fetchOpenAIVoices(forceRefresh: forceRefresh, femaleOnly: femaleOnly);
}
