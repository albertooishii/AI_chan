...
class VoiceCall {
  ...
  factory VoiceCall.fromMap(Map<String, dynamic> map) {
    return VoiceCall(
      ...
      endTime: map['endTime'] != null
          ...
          : null,
      provider: VoiceProviderExtension.fromString(map['provider'] as String),
  ...
  @override
  String toString() {
    return 'VoiceCall(id: $id, provider: ${provider.name}, status: ${status.name}, messages: ${messages.length})';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is VoiceCall && other.id == id;
  }
