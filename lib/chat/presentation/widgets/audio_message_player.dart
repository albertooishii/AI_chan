...
class _AudioMessagePlayerState extends State<AudioMessagePlayer>
  ...
  void initState() {
    ...
    _waveform = _generateWaveform(
      widget.bars,
      seed: widget.message.audio?.url?.hashCode ?? 0,
    );
    _computeDuration();
  }
            ...
            child: Container(
              ...
              child: Row(
                children: [
                    ...
                    child: SizedBox(
                      ...
                      child: LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          final int maxFit =
                              ((constraints.maxWidth + gap) / (barWidth + gap))
                                  .floor()
                                  .clamp(1, 256);
                  ...
                  if (widget.message.audio?.isAutoTts == true &&
                      widget.message.sender != MessageSender.assistant) ...[
