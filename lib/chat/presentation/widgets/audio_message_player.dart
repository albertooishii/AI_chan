...
class _AudioMessagePlayerState extends State<AudioMessagePlayer> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _waveform = _generateWaveform(widget.bars, seed: widget.message.audio?.url?.hashCode ?? 0);
    _computeDuration();
  }
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  if (widget.message.audio?.isAutoTts == true && widget.message.sender != MessageSender.assistant) ...[
