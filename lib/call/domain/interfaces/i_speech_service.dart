...
abstract interface class ICallTtsService {
  ...
  Future<String?> synthesizeToFile({required final String text, final Map<String, dynamic>? options});

  /// Convierte texto a audio en bytes
  Future<Uint8List> synthesize({required final String text, final String voice = 'default', final double speed = 1.0});
...
abstract interface class ICallSttService {
  ...
  Future<String?> transcribeFile({required final String filePath, final Map<String, dynamic>? options});
