...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  Map<String, dynamic> _getChipConfig(String type) {
    switch (type) {
      case 'sleep':
        return {'bg': Colors.indigoAccent, 'fg': Colors.white, 'icon': Icons.nightlight_round, 'label': 'Dormir'};
      case 'work':
        return {'bg': Colors.pinkAccent.shade100, 'fg': Colors.black, 'icon': Icons.work_outline, 'label': 'Trabajo'};
      case 'study':
        return {
      ...
      case 'busy':
        return {'bg': AppColors.cyberpunkYellow, 'fg': Colors.black, 'icon': Icons.schedule, 'label': 'Actividad'};
      default:
        return {'bg': AppColors.cyberpunkYellow, 'fg': Colors.black, 'icon': Icons.schedule, 'label': type};
    }
  }
