...
// Apply google-services plugin using legacy apply to ensure resources (google_app_id etc.)
// are generated by the Google Services Gradle plugin when using Kotlin DSL.
